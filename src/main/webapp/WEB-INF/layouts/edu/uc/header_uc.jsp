...
function selectBySubjectMajor(subjectId, gradeId, majorId){
						...
						<div class="tsTabCont">
							<section class="tsTabContInp">
								...
								<form id="formSearch" method="post" action="${ctx}/front/teacher/query/list">
									...
									<input id="searchcityId"  type="hidden" name="queryTeacher.cityId" value="${cityId}"/>
								...
								<form id="updateCity" method="post" action="/">
									<input id="searCityId"  type="hidden" name="cityId" value="${cityId}"/>
								</form>
							</section>
						</div>
					</section>
						...
						<section class="topbar">
							<section class="fr">
								...
								<aside class="login-infor undis login fr">
									<span class="welcome" style="font: 14px/38px 'Microsoft YaHei'">欢迎来到小雨在线教育</span>
	...
	<!-- /global nav -->
<section class="u-banner mb50" id="ucenter_banner">
</section>