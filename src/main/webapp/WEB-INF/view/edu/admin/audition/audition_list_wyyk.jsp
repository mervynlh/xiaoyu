...
<body  >
<form action="${ctx}/admin/audition/getAuditionListWYYK" name="searchForm" id="searchForm" method="post">
<input id="pageCurrentPage" type="hidden" name="page.currentPage" value="${page.currentPage}"/>
<!-- 内容 开始  -->
<div class="page_head">
				<h4><em class="icon14 i_01"></em>&nbsp;<span>约课管理</span> &gt; <span>我要约课</span> </h4>
</div>
			<!-- /tab1 begin-->
			<div class="mt20">
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01">
						...
						<c:forEach  items="${auditionList}" var="audition" >
							...
							<fmt:formatDate value="${audition.endTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
								<td>${audition.teacherName }</td>
								<td>${audition.teacherMobile }</td>
