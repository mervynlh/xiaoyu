...
<script type="text/javascript">
	function updateSubmit(){
		...
		$("#updateWebsiteTeacherForm").submit();
	}
</script>
</head>
<body>
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>推荐教师分类管理</span> &gt; <span>推荐教师分类修改</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		<form action="${ctx}/admin/website/updateWebsiteTeacher" method="post" id="updateWebsiteTeacherForm">
		<input type="hidden" name="websiteTeacher.id" value="${websiteTeacher.id}"/>
		<table width="100%" cellspacing="0" cellpupdateing="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="websiteTeacher.name" value="${websiteTeacher.name }" id="websiteTeacherName" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;更多跳转</td>
					<td>
						<input type="text"  name="websiteTeacher.link" value="${websiteTeacher.link }" id="link" class="{required:true,number:true,min:0,max:1000}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;教师数量</td>
					<td>
						<input type="text" name="websiteTeacher.teacherNum" value="${websiteTeacher.teacherNum }" id="teacherNum" value="0" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center">描述</td>
					<td>
						<textarea rows="3" cols="80" name="websiteTeacher.description" id="description">${websiteTeacher.description }</textarea>
					</td>
				</tr>
				<tr>
