...
<script type="text/javascript" language="javascript">
	...
	function drawCartogram() {
		...
		strs ='${chart}'.split("|");
		var dateTime = "[" + strs[0] + "]";
		var allOrders = "[" + strs[1] + "]";
		var payOrders = "[" + strs[2] + "]";
...
<body  >
		<form action="${ctx}/admin/statistics/order/course" name="searchForm" id="searchForm" method="post">
			<input id="pageCurrentPage" type="hidden" name="page.currentPage" value="${page.currentPage}" />
			<!-- 内容 开始  -->
				<div class="page_head">
					<h4>
						<em class="icon14 i_01"></em>&nbsp;<span>统计管理</span> &gt; <span>学员订单量统计图</span>
					</h4>
				</div>
				<!-- /tab1 begin-->
				<div class="mt20">
											...
											<div class="capHead">
												<div class="clearfix">
													...
													<div class="optionList">
														...
														<a href="/admin/order/orderPageResult" class="btn btn-danger">订单列表</a>
													</div>
												</div>
											</div>
										</caption>
