			...
			<article class="u-m-center"> 
				<section class="u-m-c-wrap"> 
					<div class="u-s-ord-details-tit">
						<a href="${ctx }/front/teacher/${teacher.id }" class="u-s-d-t-img">
							<img src="<%=staticImageServer %>${teacher.userExpand.avatar}" alt="">
						</a>
						<div class="u-s-d-t-wz">
							<p>授课老师：${teacher.userExpand.realname }</p>
							<p>
								<tt>所属地区： ${teacher.cityName } - ${teacher.districtName }</tt>
								<tt class="ml50">
									电话：${teacher.userExpand.mobile }
								</tt>
							</p>
						</div>
						<div class="u-teaname-btn fl vam">
							<a style="margin-top:35px;" href="${ctx }/front/teacher/${teacher.id }">查看详情</a>
						</div>
						<div class="clear"></div>
					</div>
					<section>
