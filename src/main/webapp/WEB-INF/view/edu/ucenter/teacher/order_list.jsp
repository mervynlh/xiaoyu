...
<body>
	<div class="u-m-right">
		<form id="searchForm" action="${ctx}/uc/teacherOrder" method="post">
								...
								<ul>
									...
									<li>
										...
										<span class="u-teaname-btn ml160 disIb vam">
											<a href="${ctx }/uc/order/getTrxorderDetail/teacher/${trxorder.id}">查看详情</a>
											<c:if test="${trxorder.trxStatus == 'INIT' }">
												<a href="${ctx }/cancleorderTeacher/${trxorder.id}">取消订单</a>
											</c:if>
